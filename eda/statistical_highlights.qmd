...
```{ojs}
//| panel: input
viewof question_select = Inputs.select(question_chisq, 
  {format: d => '(' + d.subquestion_id + ') ' + d.label_major_y + ': ' +  d.label_major_x, sort:true, unique:true}, {label: "Question:"}
)
...
viewof cramer_v_select = Inputs.range([0, max_cramer - 0.001], {value: (max_cramer / 2), step: 0.01, label: "Cramer V"});
